...
/**
 * @fn void traversal_MenuSystem(const menu_t_ptr menu_Start)
...
/**
 * @fn menu_t* find_prevMenu(const menu_t_ptr menu_Start, const menu_t* const menu)
...
/**
 * @fn menu_t* find_nextMenu(const menu_t_ptr menu_Start, const menu_t* const menu)
