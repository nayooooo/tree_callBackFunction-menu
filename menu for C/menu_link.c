...
/**
 * @fn void traversal_Menu(const menu_t_ptr menu_Start)
 * @brief traversal the menu system
 *
 * @param [menu_Start] subtree's pointer
 * @return None
 */
void traversal_Menu(const menu_t_ptr menu_Start)
{
	menu_t* p = menu_Start;
...
/**
 * @fn menu_t* find_Menu(const menu_t_ptr menu_Start, const menu_t* const menu_Target)
...
/**
 * @fn menu_t* find_parMenu(const menu_t_ptr menu_Start, const menu_t* const subMenu)
...
/**
 * @fn menu_t* insert_Menu(const menu_t_ptr menu_Start, const menu_t* const menu_Insert)
 ...
 */
menu_t* insert_Menu(const menu_t_ptr menu_Start, menu_t* const menu_Insert)
{
	menu_t p;
	menu_t* q = NULL;
 ...
 * @return [menu_t*] menu system's pointer
 */
menu_t* delete_Menu(const menu_t_ptr menu_Start, menu_t* const menu_Delete)
{
	menu_t* q = NULL;
